...
export default function App() {
  ...
  return (
    <div className={`${theme}`}>
      <div className="flex h-screen w-screen bg-slate-100 dark:bg-darkBg text-slate-900 dark:text-slate-200 overflow-hidden font-sans transition-colors duration-300">
